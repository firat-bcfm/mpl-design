...
if (!params.SKIP_APPROVAL) {
    ...
    input message: 'Deploy OZKAN to Production?', ok: 'Deploy', submitter: 'admin,ops-team'
}
...
try {
    ...
    if (CFG.'deploy.ssh_enabled') {
        ...
        def deployPath = CFG.'deploy.path' ?: '/opt/ozkan-prod'
...
echo "========================================="
echo "Application deployed to OZKAN PRODUCTION: ${env.DEPLOY_URL}"
