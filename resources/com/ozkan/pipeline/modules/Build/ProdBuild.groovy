/**
 * Ozkan Prod - Build Module
 * Step 2/6: Maven build with security checks for production
 */

echo "========================================="
echo "Step 2/6: Building application for OZKAN PRODUCTION..."
echo "========================================="
...
try {
    ...
    sh """
        ...
        echo "Project: ozkan-prod" >> target/artifacts/build-info.txt
...
echo "========================================="
echo "Production build completed successfully for OZKAN!"
echo "========================================="
